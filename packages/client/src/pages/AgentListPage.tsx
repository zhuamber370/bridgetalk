...
import { listAgents, createAgent, listTasks, listOpenClawModels } from '../lib/api';
...
export function AgentListPage() {
  ...
  const handleCreate = async () => {
    ...
    setCreating(true);
    try {
      const agent = await createAgent({ id, name, description: formDesc.trim() || undefined, model: formModel || undefined });
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400 bg-white"
                >
